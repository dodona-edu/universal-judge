...
Dat het aanleren van digitale vaardigheden nodig is, bewijst ook de opname van dat computationeel denken in de eindtermen, bijvoorbeeld in het katholieke basisonderwijs \autocite{zinin2017} of in de onderwijsdoelen voor het secundair onderwijs \autocite{2019040867}.
...
\begin{enumerate}
    ...
    Bij het aanleren van programmeren is feedback een belangrijk element om de programmeervaardigheden van de studenten te verbeteren \autocite{10.1145/2899415.2899422}.
\end{enumerate}
...
De uitdaging wordt beschouwd binnen de context van Dodona, een online leerplatform dat sinds september 2016 beschikbaar is aan de Universiteit Gent.
