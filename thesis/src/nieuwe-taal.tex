...
De tijd die nodig is om een programmeertaal te configureren is moeilijk in te schatten, want dit hangt af van meerdere factoren:

\begin{itemize}
    \item Hoe goed de programmeur bekend is met de werking van \tested{}.
    \item Hoe goed de programmeur bekend is met de werking van de programmeertaal die hij wenst te implementeren.
    \item Hoe goed de programmeertaal aansluit bij de werking van de bestaande programmeertalen van \tested{}.
\end{itemize}

We schatten dat het voor een programmeertaal die aansluit bij de bestaande programmeertalen (Java, Python, Haskell, C of Javascript) en voor iemand die bekend is met \tested{} en de programmeertaal niet zo lang zal duren: we spreken dan van een dag of twee.
Is de programmeur niet bekend met \tested{}, dan schatten we dat er toch enkel dagen nodig zullen zijn eer de programmeertaal volledig op punt staat: een dag of twee, drie of zelfs vier.
...
We spreken van onverwachte wijzigingen, omdat sommige delen van \tested{} juist voorzien zijn op wijzigingen.
