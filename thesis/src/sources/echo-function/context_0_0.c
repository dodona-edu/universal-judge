...
static void context_0_0_write_separator() {
    fprintf(context_0_0_value_file, "--CjW5hB3ZD-- SEP");
    fprintf(context_0_0_exception_file, "--CjW5hB3ZD-- SEP");
    fprintf(stdout, "--CjW5hB3ZD-- SEP");
    fprintf(stderr, "--CjW5hB3ZD-- SEP");
}
#undef send_value
...
int context_0_0() {
    context_0_0_value_file = fopen("CjW5hB3ZD_values.txt", "w");
    context_0_0_exception_file = fopen("CjW5hB3ZD_exceptions.txt", "w");
