...
static void context_0_1_write_separator() {
    fprintf(context_0_1_value_file, "--guReCXUVJ-- SEP");
    fprintf(context_0_1_exception_file, "--guReCXUVJ-- SEP");
...
int context_0_1() {
    context_0_1_value_file = fopen("guReCXUVJ_values.txt", "w");
    context_0_1_exception_file = fopen("guReCXUVJ_exceptions.txt", "w");
