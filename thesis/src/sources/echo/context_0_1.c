...
static void context_0_1_write_separator() {
    fprintf(context_0_1_value_file, "--SCbVWeLBm-- SEP");
    fprintf(context_0_1_exception_file, "--SCbVWeLBm-- SEP");
...
int context_0_1() {
    context_0_1_value_file = fopen("SCbVWeLBm_values.txt", "w");
    context_0_1_exception_file = fopen("SCbVWeLBm_exceptions.txt", "w");
