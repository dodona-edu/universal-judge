...
static void context_0_1_write_separator() {
    fprintf(context_0_1_value_file, "--bKHsgGplf-- SEP");
    fprintf(context_0_1_exception_file, "--bKHsgGplf-- SEP");
...
int context_0_1() {
    context_0_1_value_file = fopen("bKHsgGplf_values.txt", "w");
    context_0_1_exception_file = fopen("bKHsgGplf_exceptions.txt", "w");
