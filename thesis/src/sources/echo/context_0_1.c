...
static void context_0_1_write_separator() {
    fprintf(context_0_1_value_file, "--iAPYmuE8K-- SEP");
    fprintf(context_0_1_exception_file, "--iAPYmuE8K-- SEP");
    fprintf(stdout, "--iAPYmuE8K-- SEP");
    fprintf(stderr, "--iAPYmuE8K-- SEP");
}
#undef send_value
...
int context_0_1() {
    context_0_1_value_file = fopen("iAPYmuE8K_values.txt", "w");
    context_0_1_exception_file = fopen("iAPYmuE8K_exceptions.txt", "w");
