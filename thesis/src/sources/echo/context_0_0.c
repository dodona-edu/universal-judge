...
static void context_0_0_write_separator() {
    fprintf(context_0_0_value_file, "--iAPYmuE8K-- SEP");
    fprintf(context_0_0_exception_file, "--iAPYmuE8K-- SEP");
...
int context_0_0() {
    context_0_0_value_file = fopen("iAPYmuE8K_values.txt", "w");
    context_0_0_exception_file = fopen("iAPYmuE8K_exceptions.txt", "w");
