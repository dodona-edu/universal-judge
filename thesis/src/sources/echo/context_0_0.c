...
static void context_0_0_write_separator() {
    fprintf(context_0_0_value_file, "--mj0EvHqJp-- SEP");
    fprintf(context_0_0_exception_file, "--mj0EvHqJp-- SEP");
...
int context_0_0() {
    context_0_0_value_file = fopen("mj0EvHqJp_values.txt", "w");
    context_0_0_exception_file = fopen("mj0EvHqJp_exceptions.txt", "w");
