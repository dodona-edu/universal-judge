...
static void context_0_0_write_separator() {
    fprintf(context_0_0_value_file, "--ZThUjcxbS-- SEP");
    fprintf(context_0_0_exception_file, "--ZThUjcxbS-- SEP");
...
int context_0_0() {
    context_0_0_value_file = fopen("ZThUjcxbS_values.txt", "w");
    context_0_0_exception_file = fopen("ZThUjcxbS_exceptions.txt", "w");
