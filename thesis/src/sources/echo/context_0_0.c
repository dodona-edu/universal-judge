...
static void context_0_0_write_separator() {
    fprintf(context_0_0_value_file, "--Gh9VgYMHD-- SEP");
    fprintf(context_0_0_exception_file, "--Gh9VgYMHD-- SEP");
...
int context_0_0() {
    context_0_0_value_file = fopen("Gh9VgYMHD_values.txt", "w");
    context_0_0_exception_file = fopen("Gh9VgYMHD_exceptions.txt", "w");
