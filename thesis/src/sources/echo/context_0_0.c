...
static void context_0_0_write_separator() {
    fprintf(context_0_0_value_file, "--SCbVWeLBm-- SEP");
    fprintf(context_0_0_exception_file, "--SCbVWeLBm-- SEP");
    fprintf(stdout, "--SCbVWeLBm-- SEP");
    fprintf(stderr, "--SCbVWeLBm-- SEP");
}
#undef send_value
...
int context_0_0() {
    context_0_0_value_file = fopen("SCbVWeLBm_values.txt", "w");
    context_0_0_exception_file = fopen("SCbVWeLBm_exceptions.txt", "w");
