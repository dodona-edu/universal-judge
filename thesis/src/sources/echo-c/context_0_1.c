...
static void context_0_1_write_separator() {
    fprintf(context_0_1_value_file, "--ovxWVU7E8-- SEP");
    fprintf(context_0_1_exception_file, "--ovxWVU7E8-- SEP");
...
int context_0_1() {
    context_0_1_value_file = fopen("ovxWVU7E8_values.txt", "w");
    context_0_1_exception_file = fopen("ovxWVU7E8_exceptions.txt", "w");
