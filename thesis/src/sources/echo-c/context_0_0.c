...
static void context_0_0_write_separator() {
    fprintf(context_0_0_value_file, "--cZd65SxaN-- SEP");
    fprintf(context_0_0_exception_file, "--cZd65SxaN-- SEP");
...
int context_0_0() {
    ...
    context_0_0_value_file = fopen("cZd65SxaN_values.txt", "w");
    context_0_0_exception_file = fopen("cZd65SxaN_exceptions.txt", "w");
