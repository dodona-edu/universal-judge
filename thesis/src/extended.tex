...
\begin{document}
    ...
    We believe this could be solved by introducing a preprocessing step, that translates a more compact format (e.g.\ a \acronym{DSL} or domain specific language) to the test plan.
