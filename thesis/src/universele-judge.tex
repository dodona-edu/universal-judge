...
\section{Technische aspecten}\label{sec:technische-aspecten}

In deze paragraaf worden enkel technische aspecten van TESTed uitgelicht.
...
Deze package laat ons toe om nog steeds \texttt{dataclasses} en toch ook validaties te kunnen toevoegen en te exporteren naar \acronym{JSON} Schema.
\Cref{lst:programmed-evaluator-python} toont hoe de definitie van het testplan en het serialisatieformaat er uitziet.
In \cref{lst:programmed-evaluator-json} staat dan de \acronym{JSON}-variant hetzelfde element: het moge duidelijk zijn dat de omzetting van Python naar \acronym{JSON} voor de hand ligt.
