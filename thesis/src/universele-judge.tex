...
Een van die oefeningen is de \emph{\acronym{ISBN}}-oefening.
De opgave van deze oefening is opgenomen als onderdeel van \cref{sec:oefening-isbn}.
Om een idee te krijgen van hoe \tested{} werkt in de praktijk is besloten om tijdens een van de weken de \emph{\acronym{ISBN}}-oefening aan te vullen door een oefening met dezelfde opgave, maar die beoordeeld wordt door \tested{} in plaats van de Python-judge.
...
Het \acronym{JSON} Schema voor respectievelijk het testplan en het serialisatieformaat kunnen zo verkregen worden:
