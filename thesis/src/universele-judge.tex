...
\begin{enumerate}
    \item Het \term{evaluatieproces}, dat de verkregen resultaten interpreteert en beoordeelt.
    \item Het \term{kernproces}, dat zorgt voor de coördinatie tussen de andere processen, alsook de basistaken vervult.
          Dit proces is dan ook het start- en eindpunt van een evaluatie.
    \item Het \term{uitvoeringsproces}, dat de code van de student uitvoert om zo resultaten te bekomen.
\end{enumerate}
