...
Zoals vermeld in onder andere \cref{subsec:testcode-uitvoeren}, wordt de testcode voor elke context afzonderlijk uitgevoerd.
...
\begin{itemize}
    ...
    % TODO
    \item (Eerde werk, dat gebruik maakt van Jupyter-kernels voor een gelijkaardig doel, rapporteert geen problemen.): TODO: wel of niet Charlotte's thesis citeren
\end{itemize}
...
\begin{itemize}
    \item Het gebruik van de sjablonen zorgt ervoor dat het uitvoeren van de testcode minder dynamische kan zijn.
    ...
    \item Het uitvoeren op de commandoregel is wel trager indien er geen reset moet gebeuren tussen de verschillende uitvoeringen.
    % TODO: optimisation?
\end{itemize}
...
Deze meetingen zijn uitgevoerd op een standaardcomputer, niet op de Dodona-server en niet in een Docker-container.
Die beide factoren kunnen ervoor zorgen dat de uitvoeringstijden op Dodona zelf sterk verschillen van deze metingen.
...
By Python is de compilatie veel sneller en ook veel minder belangrijk (zelfs optioneel, de stap wordt enkel uitgevoerd om bepaalde syntaxisfouten vroeg op te vangen).
