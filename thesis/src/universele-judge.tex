...
Tot slot bevat X nog enkele tijdsmetingen van de verschillende implementaties van het systeem met sjablonen.
In deze tabel is de tijd gemeten om een (juiste) ingediende oplossing voor twee oefeningen te beoordelen: de voorbeeldoefening Lotto en een eenvoudigere oefening Echo.
