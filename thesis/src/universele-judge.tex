...
Een bijkomende taak die TESTed momenteel niet ondersteunt is de \term{Python Tutor}, zie \cref{subsec:kleinere-functies}.
...
\begin{description}
    ...
    \item[Vroegtijdig stoppen van uitvoering] Hier gaat het om code van de studenten die bijvoorbeeld \inlinemint{exit(-5)} bevat.
