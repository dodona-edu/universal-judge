...
Als er een compilatiefout optreed bij de compilatie in batchcompilatie, valt TESTed terug op contextcompilatie.
...
Echter, we verwachten dat dit soort zaken opgelost kunnen worden door een \acronym{DSL} of door het testplan te genereren.
