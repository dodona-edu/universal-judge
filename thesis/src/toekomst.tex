...
\subsection{Performantie}\label{subsec:future-performance}
...
In veel programmeertalen is dit een object (denk aan\texttt{DateTime in Java of datetime.Date in Python}).
