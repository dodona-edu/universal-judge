...
Een tweede standaard is PEML (\english{Programming Exercise Markup Language}) \autocite{peml}.
...
Aangezien een van de \english{design goals} van PEML is dat de omzetting van PEML naar JSON eenvoudig zal zijn, lijkt dit een interessant formaat.
