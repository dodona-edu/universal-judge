...
De beschrijving van de voorbeeldoefening staat in \cref{lst:peml} en is overgenomen uit de documentatie van \acronym{PEML}.
...
\begin{itemize}
    ...
    \end{itemize}
    \item Lange uitvoer beperken en mooier weergeven.
    Het gaat hier enerzijds om lange stacktraces (bijvoorbeeld een \mintinline{StackOverflow} uit Java) en anderzijds om grote verzameling (bijvoorbeeld een lijst van duizend elementen).
    Momenteel wordt deze uitvoer verbatim getoond aan de studenten, wat soms overweldigend is.
