...
from features import FeatureSet, NOTHING, WithFeatures
...
class NoContentChannel(WithFeatures, str, Enum):
...
class IgnoredOutputChannel(WithFeatures, str, Enum):
...
SpecialOutputChannel = Union[NoContentChannel, IgnoredOutputChannel]
...
def maybe_get_programmed_evaluator(
    ...
    if output in (NoContentChannel.NONE, IgnoredOutputChannel.IGNORED):
        return None
