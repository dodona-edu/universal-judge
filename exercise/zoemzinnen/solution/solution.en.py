def buzzphrase1(wordlists):
    ...
    >>> buzz3 = ('options', 'flexibility', 'capability', 'mobility', 'programmingconcept', 'time-phase', 'projection', 'hardware', 'contingency')
    ...
    return ' '.join(choice(wordlist) for wordlist in wordlists)
    
def buzzphrase2(*wordlists):
